...
HTML;
    ...
    {
        $this->instance->reset();
        $this->instance->setOption('path_separator', '.');
...
HTML;
    ...
    {
        self::assertInstanceOf('Twig_Loader_Filesystem', $this->instance->getLoader());
    }
...
HTML;
    ...
    {
        self::assertInstanceOf('Twig_Extension_Debug', $this->instance->getDebugExtension());
    }
