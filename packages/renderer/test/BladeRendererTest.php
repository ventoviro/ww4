...
HTML;
    ...
    {
        self::assertInstanceOf(Factory::class, $this->instance->getEngine([]));
    }
    ...
    {
        self::assertInstanceOf(\Illuminate\Filesystem\Filesystem::class, $this->instance->getFilesystem());
    }
    ...
    {
        self::assertInstanceOf('Illuminate\View\FileViewFinder', $this->instance->getFinder());
    }
    ...
    {
        self::assertInstanceOf('Illuminate\View\Engines\EngineResolver', $this->instance->getResolver());
    }
    ...
    {
        self::assertInstanceOf('Illuminate\Events\Dispatcher', $this->instance->getDispatcher());
    }
    ...
    {
        self::assertInstanceOf('Illuminate\View\Engines\CompilerEngine', $this->instance->getCompiler());
    }
